        ...
        if self.invoice_line_ids:
            for item in self.invoice_line_ids:
                ...
                itemLoad.append({
                    ...
                    'fechaFabricacion': item.product_id.fechaFabricacion.strftime("%Y-%m-%dT%I:%M:%S-05:00") if item.product_id.fechaFabricacion else '',
                    'fechaCaducidad': item.product_id.fechaCaducidad.strftime("%Y-%m-%dT%I:%M:%S-05:00") if item.product_id.fechaCaducidad else '',
