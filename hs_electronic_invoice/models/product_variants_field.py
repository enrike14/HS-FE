...
class product_field(models.Model):
    ...
    codigoGTINInv = fields.Char(
        string="Código GTIN para la unidad de inventario", size=14, help=mensaje_codigo)
    ...
    infoItem = fields.Text(
        string="Información de interés del emisor con respeto a un ítem de la FE", size=5000)
